...
'''
this solution is provided by cdeterman at https://github.com/cdeterman/Rosalind/blob/master/042_REAR/042_REAR.py
...
if __name__ == '__main__':
    ...
    # Read input data
    data = open(os.path.join(os.getcwd(), "data", "Counting_DNA_Nucleotides.dat")).readlines()
    data = [x.rstrip('\n') for x in data]
